...
logging.info("#######################################################################################")
logging.info("You are using CAPTURE-POL: CAsa Pipeline-cum-Toolkit for Upgraded GMRT data REduction -POL")
logging.info("This pipeline has been developed at NCRA by Ruta Kale and the interferometric data analysis pipelines team.")
logging.info("#######################################################################################")
...
# an initial bandpass
        ...
        default(gaincal)
        gaincal(vis=msfilename, caltable=str(msfilename)+'.AP.G0'+mycalsuffix, append=False, field=str(','.join(mybpcals)), 
        ...
        for i in range(0,len(myallcals)):
                if i == 0:
                        ...
                        if os.path.isdir(str(msfilename)+'.AP.G'+mycalsuffix) == True:
                                ...
                                appflag = False
                mygaincal_ap2(msfilename,myallcals[i],ref_ant,gainspw,uvracal,mycalsuffix,appflag)       
# Get flux scale
...
# an initial bandpass
        if os.path.isdir(str(msfilename)+'.AP.G0'+mycalsuffix) == True:
                os.system('rm -rf '+str(msfilename)+'.AP.G0'+mycalsuffix)
        default(gaincal)
        gaincal(vis=msfilename, caltable=str(msfilename)+'.AP.G0'+mycalsuffix, field=str(','.join(mybpcals)), 
...
#                                gfields =[unpolcalib,myampcals[0],mybpcals,polcalib]#[myampcals[0],mycals,mybpcals,polcalib]
                                gfields =[unpolcalib,myampcals[0],'',polcalib]#[myampcals[0],mycals,mybpcals,polcalib]
...
#                                gfields =[polcalib,myampcals[0],mybpcals,polcalib,unpolcalib]#[myampcals[0],mycals,mybpcals,polcalib,unpolcalib]
                                gfields =[polcalib,myampcals[0],'',polcalib,unpolcalib]#[myampcals[0],mycals,mybpcals,polcalib,unpolcalib]
...
#                                gfields =[myampcals[0],myampcals[0],mybpcals,myampcals[0],polcalib,unpolcalib,polcalib]# [myampcals[0],mybpcals,myampcals[0],polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
                                gfields =[myampcals[0],myampcals[0],'',myampcals[0],polcalib,unpolcalib,polcalib]# [myampcals[0],mybpcals,myampcals[0],polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
                                logging.info("gainfields used %s",str(gfields))
...
###########################################
 ...
 #leakage1, polang1]
                                ...
                                gfields = [myampcals[0],'',myampcals[0],polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
                                logging.info("gainfields used %s",str(gfields))
...
# leakage1, polang1]
                                logging.info("gaintables used %s", str(gtables))
                                if mypcals != []:
                                        gfields = [myampcals[0],'',', '.join(mypcals),polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
...
#                                       gfields = [myampcals[0],mybpcals,myampcals[0],polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
                                        gfields = [myampcals[0],'',pampcal,polcalib,unpolcalib,polcalib] #[kcorrfield,bpassfield,fluxfield, polcalib, unpolcalib, polcalib]
                                logging.info("gainfields used %s",str(gfields))
...
#myselfcal(myfile2,ref_ant,scaloops,pcaloops,mJythreshold,imcellsize,imsize_pix,use_nterms,nwprojpl,scalsolints,clipresid,myflagspw,mygainspw2,mymakedirty,niter_start,clean_robust)
